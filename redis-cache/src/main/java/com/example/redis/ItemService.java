...
public class ItemService {
	...
	// 이 메서드의 결과는 캐싱가 가능하다.
	// 인자들 중 첫 번째를 key를 넣을거다.
	// cacheNames : 요 메서드로 인해서 만들어질 캐시를 지칭하는 이름
	// key : 캐시 데이터를 구분하기 위해 활용하는 값
	@Cacheable(cacheNames = "itemCache", key = "args[0]") // 인자들 중 첫번째 ex) Long id,
	...
	public Page<ItemDto> serachByName(String query, Pageable pageable) {
